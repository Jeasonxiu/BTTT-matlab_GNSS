function [r_eci,v_eci] = ecef2eci2(jd,r_ecef,v_ecef)
...
%% 테스트를 위한 파라미터 입력
% clear all; close all;
% r_ecef = [-1033.479383,7901.2952754,6380.3565958];              % example : p.230, vallado 4th edition
% v_ecef = [-3.225636520,-2.872451450,5.531924446];               % example : p.230, vallado 4th edition
% jd=2453101.828154745;                                           % example : p.230, vallado 4th edition
