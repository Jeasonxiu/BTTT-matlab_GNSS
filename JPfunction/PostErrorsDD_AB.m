function [DDdXYZ, DDdNEV, DDdis, DDrms, DDstd] = PostErrorsDD_AB(estm, Base, Truedis, ymin, ymax, SYS); 
%
% [DDdXYZ, DDdNEV, DDdis, DDrms, DDstd] = PostErrorsDD_AB(estm, Base, Truedis, ymin, ymax, SYS);
%
