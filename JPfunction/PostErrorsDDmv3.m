function [DDdXYZ, DDdNEV, DDdis, DDrms, DDstd] = PostErrorsDDmv3(estm, Base, Truedis, ymin, ymax, SYS); 
%
% [DDdXYZ, DDdNEV, DDdis, DDrms, DDstd] = PostErrorsDDmv3(estm, Base, Truedis, ymin, ymax, SYS); 
%
...
%     DDdNE(aa,:) = (sqrt(DDdXYZ(aa,1)^2 + DDdXYZ(aa,2)^2));
    ...
    TrueDis(aa,1:4) = [BsRvDis, truedN, truedE, truedV];
