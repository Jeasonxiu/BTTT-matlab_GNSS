function [estm] = DPP_gc(QMfile,eph,TruePos, RTCM, DOY, YY)
...
% QMfile = 'ANSG_17214_u1-1'; navfile = 'brdm2140.17p'; YY = 17; DOY =214;        % 안성
...
%                     if PRC == 0
%                         com = rho + x(4) - CCC*dtSat +dIono + dTrop; % gps 계산값
%                     else
                        com = rho + x(4) - CCC*dtSat  - PRC; % bds 계산값
%                     end
...
%                     if PRC == 0
%                         com = rho + x(5) - CCC*dtSat + dIono + dTrop; % bds 계산값
%                     else
                        com = rho + x(5) - CCC*dtSat  - PRC; % bds 계산값
%                     end
