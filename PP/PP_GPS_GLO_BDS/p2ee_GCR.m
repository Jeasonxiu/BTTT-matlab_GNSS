% function [estm] = PP_grc(QMfile,eph,TruePos, DOY, YY)
...
%% QM 파일, 날짜 핸들링
FileQM = 'Q362GEO_dt';
% FileQM =  'Q2110040';       % 갤럭시 노트 8 171228
% FileQM = 'QG3030040';     % 갤럭시 노트 8 180104
...
TruePos =  [-3026676.0349   4067187.8093   3857246.8611]; % 4호관
...
% load('180103_galaxy_test.mat');
% load('180104_galaxy_test.mat');
...
%         HTy = zeros(4,1);
        ...
        QM1 = QM(indexQM,:);
%         QM1 = QM1(find(QM1(:,2) < 200),:);
        existprn = intersect(QM1(:,2),eph(:,18));
