function [STT] = GetSTTbrdc_GLO(gs, eph, icol, vec_site, deltat)
%
%function [STT] = GetSTTbrdc_GLO(gs, eph, icol, vec_site)
%
...
for iter = 1:MaxIter
    tau_s = gs - stt_0;
    vec_sat = GetSatPosGLO(eph, icol, tau_s, deltat); vec_sat = vec_sat';
