...
% Last Modified by GUIDE v2.5 11-Nov-2016 08:29:59
...
%             [hh,mm,ss,la,lo,qi,ht] = NEWreadGGA2(GGA);
            [hh,mm,ss,x,y,z,la,lo,qi,nSats,ht] = NEWreadGGA(GGA) 
            set(handles.edit1,'String',GGA);
...
%% 오차 그래프
% --- Executes on button press in posterror.
function posterror_Callback(hObject, eventdata, handles)
% hObject    handle to posterror (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%% result(EPOCH,:) = [dN, dE, dV, dNE, d3, qi, nSats];
