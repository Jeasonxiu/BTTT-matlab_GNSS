...
% prFileName = 'pseudoranges_log_2017_10_13_14_46_27.txt';        % 대성 B 지점 171013
% prFileName = 'pseudoranges_log_2016_10_05_14_09_43.txt';        % 161005 N9 교수님 자료
% prFileName = 'N8_IH_gnss_log_2018_05_29_10_54_40.txt';        % 180529 Note8 Inha
% prFileName = 'N9U_B_gnss_log_2018_05_29_10_07_30.txt';        % 180529 NEXUS9 UP
% prFileName = 'N9D_B_gnss_log_2018_05_29_11_14_20.txt';        % 180529 NEXUS9 DOWN
% prFileName = 'S8_B_gnss_log_2018_05_15_15_14_46.txt';
% prFileName = 'S8_B_gnss_log_2018_05_25_08_06_05.txt';        % S8 180525
% prFileName = 'S8_B_gnss_log_2018_05_27_17_10_57.txt';        % S8 180527 
% prFileName = 'S8_B_gnss_log_2018_05_28_11_06_51.txt';     % S8 180528 1
% prFileName = 'P_B_gnss_log_2018_05_28_11_06_47.txt';      % Pixel 180528 1
% prFileName = 'N9_B_gnss_log_2018_05_28_14_15_34.txt';       % N9 180528 2
% prFileName = 'S8_B_gnss_log_2018_05_28_14_15_35.txt';       % N8 180601 1
prFileName = 'N8_B_gnss_log_2018_06_01_13_23_44.txt';
% as follows
...
% dirName = 'E:\PPSoln\PPSoln-js\matlab\data\testdata\RTK\180525_S8';
% dirName = 'E:\PPSoln\PPSoln-js\matlab\data\testdata\RTK\180527_JAVAD_S8';
% dirName = 'E:\PPSoln\PPSoln-js\matlab\data\testdata\RTK\180528_JAVAD_S8_P';
% dirName = 'E:\PPSoln\PPSoln-js\matlab\data\testdata\RTK\180528_JAVAD_S8_N';
% dirName = 'E:\PPSoln\PPSoln-js\matlab\data\testdata\RTK\161005_Nexus9';
% dirName = 'E:\PPSoln\PPSoln-js\matlab\data\testdata\RTK\180529_Note8';
% dirName = 'E:\PPSoln\PPSoln-js\matlab\data\testdata\RTK\180529_JAVAD_N';
dirName = 'E:\PPSoln\PPSoln-js\matlab\data\testdata\RTK\180601_JAVAD_N8';
% dirName = 'E:\PPSoln\PPSoln-js\matlab\data\Smartphone\170801';     % 대성 B point
% dirName = 'E:\PPSoln\PPSoln-js\matlab\data\testdata\RTK\180515_JAVAD'
...
for i=1:length(gpsPvt.numSvs)
    lla = gpsPvt.allLlaDegDegM(i,:);
    xyz = gd2xyz(lla);
    estm_gg(i,1) = 0;
    estm_gg(i,2:4) = xyz;
    estm_gg(i,5) = gpsPvt.allBcMeters(i);
    estm_gg(i,6) = 0;
    estm_gg(i,7) = gpsPvt.numSvs(i);
end
