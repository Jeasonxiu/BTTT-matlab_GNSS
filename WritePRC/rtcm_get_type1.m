function data = rtcm_get_type1(numofword)
%
...
for m=1:k
    ...
    data(i,6) = bitand( bitshift( now_word, -14 ), numofbits(8) );
    i=i+1;
    ...
    rtcm_next_word();
    data(i,6) = bitand( bitshift( now_word, -22 ), numofbits(8) );
    i=i+1;
    ...
    data(i,6) = bitand( bitshift( now_word, -6  ), numofbits(8) );
    rtcm_next_word();
    i=i+1;
end
