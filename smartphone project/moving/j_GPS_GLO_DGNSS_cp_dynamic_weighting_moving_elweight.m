...
for j = 1:NoEpochs
    ...
    sys_w = [GpsSats/NoSats+0.1, GloSats/NoSats-0.1];           % 항법시스템 가중치설정 전체 위성수에 대한 각 시스템 비율
...
%                         W = 1;
                        ...
                        HTy_cp = HTy_cp + H'*W*sys_w(2)*cp;              % DGLO_cp
                    end
                end
            end
        end
...
[dXYZ_cp, dNEV_cp] = PosTErrors5(estm_cp, UBLOX, visiSat);
